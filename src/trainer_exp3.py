...
def main():
    ...
    train_dataset = YelpDataset(
        args.train_data_file, tokenizer, use_rating=True
    )
    val_dataset = YelpDataset(args.val_data_file, tokenizer, use_rating=True)
    ...
    print("Experiment 3: Controlled - business ratings numeric")
