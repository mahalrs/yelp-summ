...
def main():
    ...
    train_dataset = YelpDataset(
        args.train_data_file, tokenizer, use_rating=True, rating_as_text=True
    )
    val_dataset = YelpDataset(
        args.val_data_file, tokenizer, use_rating=True, rating_as_text=True
    )
    ...
    print("Experiment 4: Controlled - business ratings as text")
